...
internal object BackupJson {
    ...
    fun encode(value: DiarySnapshot, includeHealth: Boolean = false): JSONObject = json(
        "format" to "com.atay.iz.backup", "version" to VERSION, "exportedAt" to System.currentTimeMillis(),
    ...
    fun decode(value: JSONObject): DiarySnapshot {
        require(value.getString("format") == "com.atay.iz.backup") { "Bu dosya bir İz yedeği değil." }
