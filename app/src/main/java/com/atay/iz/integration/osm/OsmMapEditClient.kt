...
import com.atay.iz.integration.OsmServiceEndpoints
import com.atay.iz.integration.isAllowedOsmEndpoint
...
internal class OsmMapEditClient(
    ...
    companion object {
        ...
        private val userAgent get() = "Iz/${BuildConfig.VERSION_NAME} (com.atay.iz; OSM editor)"
    }
}
