...
class WearSnapshotFactoryTest {
    ...
    @Test fun runningPaceIncludesPausedTimeAndPhoneStepsStaySeparateFromWatchSteps() {
        ...
        assertEquals(com.atay.iz.wearprotocol.WearMode.RUN, state.mode)
    ...
    @Test fun weatherAppearsForEveryActivelyRecordedJourneyMode() {
        val weather = com.atay.iz.wearprotocol.WearRouteWeather(
            com.atay.iz.wearprotocol.WearWeatherStatus.READY,
            calculatedAt = start,
