...
class WatchHealthService : Service() {
    ...
    private fun notification(text: String): Notification {
        ...
        return Notification.Builder(this, CHANNEL).setSmallIcon(com.atay.iz.watch.R.drawable.ic_watch)
    ...
    companion object { private const val CHANNEL = "watch_health"; private const val NOTIFICATION = 4100; private const val ACTION_DISARM = "com.atay.iz.DISARM_HEALTH"
        internal const val ACTION_REBIND = "com.atay.iz.REBIND_HEALTH_PHONE" }
}
