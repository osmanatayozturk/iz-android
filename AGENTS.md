...
6. Değişikliği görev dalında hazırla ve `osmanatayozturk/iz-android` deposunda PR aç. Doğrudan `main` gönderimi yapma. Public PR açıklamasına veya yorumlarına sır, kişisel veri, hassas güvenlik raporu ya da açığın kötüye kullanılmasını sağlayacak ayrıntı ekleme.
...
Sürüm planı bir uygulama yol haritasıdır; kendiliğinden zamanlı veya arka plan görevi oluşturmaz. Ayrı kurulmuş **İz kod güvenlik incelemesi** görevi PR açılışını ve yeni commitleri Güvenlik sohbetindeki inceleme için takip eder; zamanlı görev yoktur. Görev yorumu teknik yayın kilidi değildir. Zorunlu GitHub kontrolleri, dal koruması ve dağıtım kimlik bilgilerinin kısıtlanması henüz yapılandırılmadı. Bu durum, ajanın yukarıdaki yayın kuralını atlamasına izin vermez. Kullanıcının onaylamadığı özellikleri sonraki sürüme taahhüt etme.
